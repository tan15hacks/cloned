...
export const game_render_1 = {
  ...
  showHowToPlay() {
    this.openModal("How to Play Hearthvale v3.12", `<section class="help-section"><h3>Farmhouse Cooking</h3><p>Enter the Farmhouse and use the stove to prepare known recipes. The cookbook may be reviewed from its shelf or from the Adventure Menu. Standard cooking uses lower-quality ingredients first; Use Best Ingredients spends premium crops, fish, or ranch products for a stronger dish.</p></section><section class="help-section"><h3>Meals and Buffs</h3><p>Prepared meals are stored by quality in the pantry and may be eaten anywhere. Food restores health and energy and grants one temporary meal effect. Eating another meal replaces the current effect. The HUD shows the active food and remaining game time.</p></section><section class="help-section"><h3>Recipes and Cooking Levels</h3><p>Cook food to raise Cooking from Level 1 to 10. Three recipes are available immediately, more appear at Cooking milestones, and selected recipes arrive through mailbox letters after resident heart events.</p></section><section class="help-section"><h3>Relationships and Mailbox</h3><p>Talk to each resident once per day. Give one gift per day and up to two gifts per resident each week. Birthday gifts receive stronger bonuses. Check the Farmstead mailbox for reminders, rewards, heart-event invitations, and personal recipes.</p></section><section class="help-section"><h3>Playable Buildings</h3><p>Open shops, inns, Starwatch, City Hall, the Farmhouse, and the Guild have lightweight interiors. Walk to highlighted counters and furnishings to use their services. Businesses follow opening hours.</p></section><section class="help-section"><h3>Farming, Ranching, and Seasons</h3><p>Grow quality crops, catch fish, forage, care for six animal species, upgrade the Coop, Barn, and Silo, process artisan goods, and prepare for four 28-day seasons and their annual festivals.</p></section><section class="help-section"><h3>Guided Story</h3><p>Follow the objective panel and golden marker through Chapter 1 and Chapter 2. Required story dialogue takes priority over ordinary relationship conversations.</p></section><section class="help-section"><h3>Directional Combat</h3><p>Select the sword, face an enemy, and press Space/F or the mobile A button. Watch telegraphs, dodge projectiles, collect loot, equip suitable gear, and use meal effects to prepare for difficult regions and bosses.</p></section><section class="help-section"><h3>57,344-Tile Continent</h3><p>The 256 × 224 map streams only nearby 16 × 16 chunks. The Grand Depths contain 50 floors, milestone bosses, shortcuts, merchants, and deterministic 1% floor chests.</p></section><section class="help-section"><h3>Controls</h3><p>Desktop: WASD/arrows move, E interact, Space/F tool or attack, 1–8 toolbar, Q seeds, M menu. Mobile: movement stick, A tool/attack, B interact.</p></section>`, [{ label: "Close", action: () => this.closeModal() }]);
  },
