...
export const game_render_1 = {
  ...
  showHowToPlay() {
    this.openModal("How to Play Hearthvale v3.11", `<section class="help-section"><h3>Relationships and Mailbox</h3><p>Talk to each resident once per day. Give one gift per day and up to two gifts per resident each week. Loved, liked, neutral, and disliked items affect friendship differently, and birthday gifts receive stronger bonuses. Check the mailbox beside the farmhouse for birthday reminders, rewards, and heart-event invitations.</p></section><section class="help-section"><h3>Heart Events</h3><p>At 3, 6, and 9 friendship, a resident sends an invitation naming a building and time window. Enter that interior during the scheduled hours and interact with the resident marked by a heart.</p></section><section class="help-section"><h3>Playable Buildings</h3><p>Open shops, inns, Starwatch, City Hall, the Farmhouse, and the Guild have lightweight interiors. Walk to highlighted counters and furnishings to use their services. Businesses follow opening hours.</p></section><section class="help-section"><h3>Farming, Ranching, and Seasons</h3><p>Grow crops, care for six animal species, upgrade the Coop, Barn, and Silo, process artisan goods, and prepare for four 28-day seasons and their annual festivals.</p></section><section class="help-section"><h3>Guided Story</h3><p>Follow the objective panel and golden marker through Chapter 1 and Chapter 2. Required story dialogue takes priority over ordinary relationship conversations.</p></section><section class="help-section"><h3>Directional Combat</h3><p>Select the sword, face an enemy, and press Space/F or the mobile A button. Attacks only hit the forward arc. Watch telegraphs, dodge projectiles, collect loot, and equip gear suited to regional status effects.</p></section><section class="help-section"><h3>57,344-Tile Continent</h3><p>The 256 × 224 map streams only nearby 16 × 16 chunks. The Grand Depths contain 50 floors, milestone bosses, shortcuts, merchants, and deterministic 1% floor chests.</p></section><section class="help-section"><h3>Controls</h3><p>Desktop: WASD/arrows move, E interact, Space/F tool or attack, 1–8 toolbar, Q seeds, M menu. Mobile: movement stick, A tool/attack, B interact.</p></section>`, [{ label: "Close", action: () => this.closeModal() }]);
  },
